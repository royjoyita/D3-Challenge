...
// import csv data
d3.csv("assets/main_data/data.csv").then(function(main_data) {
    ...
    var xLinearScale = d3.scaleLinear()
       .domain([d3.min(main_data, d => d.poverty)*0.9, d3.max(main_data, d => d.poverty)])
       .range([0, width]);


    var yLinearScale = d3.scaleLinear()
       .domain([0, d3.max(main_data, d => d.healthcare)*1.0])
       .range([height, 0]);
